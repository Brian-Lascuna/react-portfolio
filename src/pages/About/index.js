                ...
                <div className="flex flex-col items-start w-screen mx-6 bg-white border-4 border-black rounded-lg shadow md:flex-row dark:border-gray-700 dark:bg-gray-800 aboutColor">
                    ...
                    <div className="flex flex-col justify-between p-4 leading-normal">
                        ...
                        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                            Hi, my name is Brian Lascuna and I'm an aspiring programmer striving to learn more within the industry and challenge myself, whether it be develpment technologies 
                            ...
                            to quickly learn and master new skills. I'm an all around team player, willing to adapt to any role to ensure the project is successful. This portfolio documents my experiences with full stack development
                            and is currently outdated.
                        </p>
